...
import { ArrowLeft, Tv, Building, User } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>TV Bill Payment</Text>
            ...
            {tvProviders.map((provider) => (
              ...
              >
                <View style={[styles.providerIcon, { backgroundColor: provider.color + '20' }]}>
                  <Tv size={24} color={provider.color} />
                </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder="Customer ID / Smart Card No."
