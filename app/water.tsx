...
import { ArrowLeft, Droplets, Building, User } from 'lucide-react-native';
...
export default function WaterScreen() {
  ...
  const quickAmounts = [200, 500, 800, 1200, 1500, 2000];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Select Water Provider</Text>
            ...
            {providers.map((provider) => (
              ...
              >
                <View style={[styles.providerIcon, { backgroundColor: provider.color + '20' }]}>
                  <Droplets size={24} color={provider.color} />
                </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder="Customer Number / Account No."
